...
const benefits = [
  ...
  { icon: '🚚', title: 'Coordinamos entrega', desc: 'Entrega o retiro según tu conveniencia. Te acompañamos en el proceso.' },
]
...
const faqs = [
  {
    ...
    a: 'Agregá los productos que querés al carrito y presioná "Enviar pedido por WhatsApp". Te escribiremos de inmediato para coordinar entrega y forma de pago.',
  },
  {
    q: '¿Hacen entregas a domicilio?',
    a: 'Sí. Coordinamos entregas en el Gran Área Metropolitana. También podés pasar a retirar en Tibás. Consultanos por WhatsApp para más detalles.',
  },
  {
    q: '¿Cuáles son los métodos de pago?',
    a: 'Aceptamos SINPE Móvil, transferencia bancaria y efectivo. Te indicamos todos los detalles al confirmar tu pedido.',
  },
  {
    q: '¿Los productos son seguros?',
    a: 'Todos son suplementos alimenticios de marcas reconocidas. Son seguros para la mayoría de personas, pero si tenés alguna condición médica, consultá con tu médico antes de consumirlos.',
  },
  {
    q: '¿Puedo pedir un producto específico que no veo en la tienda?',
    a: '¡Por supuesto! Escribinos por WhatsApp y con gusto te ayudamos a encontrar lo que buscás o lo conseguimos para vos.',
  },
]
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
          <div className="max-w-xl">
            <p className="text-brand-gold font-body font-medium tracking-[0.2em] uppercase text-sm mb-4 animate-fade-in">
              🌿 Bienestar natural costarricense
            </p>
            <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl text-white leading-[1.05] mb-6 animate-slide-up">
              Bienestar natural<br />
              <em className="text-brand-gold not-italic">para tu día a día</em>
            </h1>
            <p className="text-white/80 text-lg leading-relaxed mb-8 font-light animate-slide-up">
            ...
            <div className="flex flex-wrap gap-3 animate-slide-up">
              <Link
                href="/tienda"
                className="inline-flex items-center gap-2 bg-brand-gold text-white font-medium px-7 py-3.5 rounded-full hover:bg-brand-gold/90 transition-all duration-200 group"
              >
                Comprar ahora
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/30 text-white font-medium px-7 py-3.5 rounded-full hover:bg-white/20 transition-all duration-200"
              >
      ...
      <section className="py-20 bg-brand-ivory">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
            ...
            <Link
              href="/tienda"
              className="inline-flex items-center gap-2 text-brand-green font-medium hover:gap-3 transition-all text-sm group"
            >
      ...
      <section className="py-20 bg-brand-green">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 mt-3 max-w-lg mx-auto text-sm leading-relaxed">
              ¿No sabés por dónde empezar? Elegí según lo que tu cuerpo necesita hoy.
            </p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {needs.map((need) => (
              <Link
                ...
                className="group bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/20 rounded-2xl p-4 text-center transition-all duration-200 hover:scale-105"
              >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((s, i) => (
              <div key={s.n} className="relative">
                {i < steps.length - 1 && (
                  <div className="hidden lg:block absolute top-8 left-full w-full h-px border-t-2 border-dashed border-brand-beige z-0" />
                )}
          ...
          <div className="text-center mt-12">
            <Link
              href="/tienda"
              className="inline-flex items-center gap-2 bg-brand-green text-white font-medium px-8 py-4 rounded-full hover:bg-brand-green/90 transition-all duration-200 group text-lg"
            >
              Empezar a comprar
      ...
      <section className="py-20 bg-brand-charcoal relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <Image src="/brand/logo-gold.jpg" alt="" fill className="object-cover blur-2xl scale-150" />
        </div>
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <div className="relative h-20 w-44 mx-auto mb-6">
            <Image src="/brand/logo-dark.jpg" alt="Monte Alma" fill className="object-contain" />
          </div>
          ...
          <p className="text-white/70 mb-8 leading-relaxed max-w-lg mx-auto">
            Comenzá tu rutina de bienestar natural hoy. Explorá nuestra tienda o escribinos directamente, estamos para ayudarte a encontrar lo que necesitás.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/tienda"
              className="inline-flex items-center gap-2 bg-brand-gold text-white font-medium px-7 py-3.5 rounded-full hover:bg-brand-gold/90 transition-all duration-200"
            >
              Ver tienda completa
            </Link>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 border border-white/30 text-white font-medium px-7 py-3.5 rounded-full hover:bg-white/10 transition-all duration-200"
            >
